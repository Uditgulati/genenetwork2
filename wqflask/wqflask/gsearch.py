...
class GSearch(object):
    ...
    def __init__(self, kw):
        ...
        if self.type == "gene":
            ...
            # dsname_to_dataset = {} # stores dataset name to dataset object
            ...
            with Bench("Creating trait objects"):
                ...
                for i, line in enumerate(re):
                    ...
                    # t1 += ta
                    # t4 += td
                    # print(":udit:", this_trait['dataset'], ":udit:", this_trait['name'])
                    # first_set.add(this_trait['dataset'])
                    # second_set.add(this_trait['name'])
                    # pair_set.add((this_trait['dataset'], this_trait['name']))
                    # print(this_trait['dataset_id'])
                    ...
                    # break
                # print(":len:", len(re), len(first_set), len(second_set), len(pair_set))
                # print(":time:", t1, t2, t3, t4, xx1, xx2)
